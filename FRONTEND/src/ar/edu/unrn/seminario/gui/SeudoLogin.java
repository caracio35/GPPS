...
public class SeudoLogin extends JFrame {
	...
	private JTextField crearCampoTextoModerno() {
		...
		campo.setBorder(new CompoundBorder(new LineBorder(COLOR_SECUNDARIO, 1, true), new EmptyBorder(8, 10, 8, 10)));
	...
	private void crearUsuarioYAbrirVentana() {
		// Validación básica
		if (nombreField.getText().isEmpty() || apellidoField.getText().isEmpty() || dniField.getText().isEmpty()
				|| correoField.getText().isEmpty() || nombreUsuarioField.getText().isEmpty()) {
		...
		UsuarioSimplificadoDTO usuario = new UsuarioSimplificadoDTO(nombreField.getText(), apellidoField.getText(),
				correoField.getText(), (String) roleComboBox.getSelectedItem(), dni, nombreUsuarioField.getText());
