	  ...
	  private JTextField tfEntidad, tfCuitEntidad;
	    ...
	    public VentanaCrearConvenio(IApi api, String tituloProyecto) {
	        ...
	        datePanel.addActionListener(e -> {
	            ...
	            if (selectedDate != null && selectedDate.before(new Date())) {
	                JOptionPane.showMessageDialog(this, "¡No se pueden seleccionar fechas pasadas!", "Error", JOptionPane.ERROR_MESSAGE);
	    ...
	    private void generarConvenio() {
	        try {
	            ...
	            JOptionPane.showMessageDialog(this, "Error al generar el acta: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
	        }
	    }
